...
public class SongService implements SongRepository {
    ...
    public SongService() {
        ...
        playlist.put(2, new Song(2, "Kathari Poovazhagi", "Vijay", "Benny Dayal", "A.R. Rahaman"));
        playlist.put(3, new Song(3, "Tum Hi Ho", "Mithoon", "Arijit Singh", "Mithoon"));
        playlist.put(4, new Song(4, "Vizhiyil", "Vairamuthu", "Unni Menon", "A.R. Rahaman"));
    ...
    public ArrayList<Song> getSongs() {
        Collection<Song> songCollectionList = playlist.values();
        ArrayList<Song> songs = new ArrayList<>(songCollectionList);
        return songs;
    }
